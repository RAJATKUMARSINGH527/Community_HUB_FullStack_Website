...
//                 {post.userId === userId && (
//                   <div className="icon-container">
//                     <button className="edit-post" onClick={() => setEditingPost(post._id)}>✏️</button>
//                     <button className="delete-post" onClick={() => handleDelete(post._id)}>🗑️</button>
//                   </div>
//                 )}
//               </div>
...
//               <div className="post-actions">
//                 <button onClick={() => handleLike(post._id)}>
//                   {likedPosts.has(post._id) ? "❤️ Liked" : "🤍 Like"} {post.likes || 0}
//                 </button>
//                 <button onClick={() => toggleComments(post._id)}>
